...
# Processes to kill
TO_KILL="chrome dropbox firefox pidgin skype thunderbird hexchat discord zoom slack"
...
warning() {
	...
	echo "\n[i] Please edit /etc/default/securonis-router with your custom values."
}
